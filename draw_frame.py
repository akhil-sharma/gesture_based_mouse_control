...
class DrawFrame:
        ...
        if contours is not None and len(contours) > 0:
            ...
            if centroid is not None and defects is not None and len(defects) > 0:
                ...
                if farthest_point is not None:
                    ...
                    self.move_mouse(farthest_point)
    ...
    def move_mouse(self, farthest_point):
        initial_x, initial_y = farthest_point
        x_change_ratio = self.screen_width/533
        y_change_ratio = self.screen_height/400
        pag.moveTo(int(initial_x * x_change_ratio), int(initial_y * y_change_ratio), duration=0.0)
